...
from dekf_bench.utils.paths import figures_dir
...
def write_summary(labels) -> None:
    ...
    # Raw: the body carries LaTeX, and `\star` is an invalid escape sequence that
    # Python currently warns about and will one day treat as an error.
    text = rf"""# Preliminary work — status and figures
